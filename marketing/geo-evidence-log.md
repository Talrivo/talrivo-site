...
- Do not invent inquiry numbers, sales results, customer names or test data.
- Use only verified product details, visible image evidence, sample notes, customer questions or internal product facts.
- If a claim is not verified, write it as a review point, not as a performance promise.
- Every website article should link to a product page, category page and contact or sample request page.
...
- The page answers one clear buyer question.
- The first paragraph gives a direct answer.
