...
- black-red and white product color options;
- receiver and microphone details;
- useful for gaming audio brands preparing a sample discussion.

### Day 3: Wired vs wireless comparison
...
- wired models for direct RGB style;
- wireless models for cleaner setups;
- point buyers to product selection, not generic promotion.

### Day 5: Sample request guide
...
- what to prepare before requesting gaming headset samples;
- model direction, quantity, logo needs, packaging direction and target market.

## Week 2

### Day 1: Product evidence checklist
...
- product image, model detail, sample note and comparison evidence;
- explain how TALRIVO evaluates content topics.

### Day 3: G941 model page
...
- ANC positioning;
- product details and sample request path.
...
- how buyers can get a cleaner quotation;
- product model, quantity, customization, package and shipping direction.
...
- URL used;
- image or video used;
- reactions, comments and messages;
- inquiry email source context, if any.

If a post gets comments or messages, turn the question into:

- one FAQ answer;
- one article section;
- one internal note in `marketing/geo-evidence-log.md`.
